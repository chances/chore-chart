  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: ChoresTheme.biceBlue),
        child: Column(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    style:
                        Theme.of(context).typography.white.bodyLarge?.copyWith(letterSpacing: 0.0),
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed(
                        'ResetPassword',
                        extra: <String, dynamic>{kTransitionInfo: PageTransitionType.rightToLeft},
                      );
                    },
                    child: Text(
                      'Reset Password',
